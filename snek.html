...
// Calculate total items in cart for display in header (same as checkout.php)
$cart_item_count = 0;
...
<body>
        ...
        <section class="payment-section">
          ...
          <div class="shipping-details">
            <?php if (!empty($shipping_info)): ?>
              <p><strong>Full Name:</strong> <?php echo htmlspecialchars($shipping_info['full_name']); ?></p>
              ...
              <p><strong>State:</strong> <?php echo htmlspecialchars($shipping_info['state']); ?></p>
              <p><strong>Zip Code:</strong> <?php echo htmlspecialchars($shipping_info['zip']); ?></p>
            <?php else: ?>
  ...
  <script>
    ...
    function closeModal() {
        ...
        window.location.href = 'ourproducts.php'; // Example: Redirect to products page
    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        <?php if ($payment_successful): ?>
            showConfirmationModal('<?php echo htmlspecialchars($payment_method_used); ?>');
        <?php endif; ?>
    });
  </script>
</body>
