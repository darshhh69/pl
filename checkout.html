...
// Handle Remove from Cart action (similar to ourproducts.php but for checkout page)
...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Footer Styles (identical to ourproducts.php) */
    footer {
      background: #000;
      color: #fff;
      padding: 3rem 2;
...
<body>
    ...
    <div class="container">
      ...
      <div class="checkout-container">
        <section class="checkout-section" style="flex: 2;">
          ...
          <?php if (empty($_SESSION['cart'])): ?>
            ...
            <div style="text-align: center; margin-top: 2rem;">
                <a href="ourproducts.php" class="place-order-btn" style="display: inline-block; width: auto; padding: 0.75rem 1.5rem;">Continue Shopping</a>
            </div>
          <?php else: ?>
              ...
              <?php foreach ($_SESSION['cart'] as $item): ?>
                <li class="checkout-cart-item">
                  ...
                  <div class="checkout-item-details">
                    ...
                    <form class="quantity-controls" method="post" action="checkout.php">
                        <input type="hidden" name="product_id" value="<?php echo htmlspecialchars($item['id']); ?>">
                        <label for="quantity-<?php echo htmlspecialchars($item['id']); ?>" class="sr-only">Quantity for <?php echo htmlspecialchars($item['name']); ?></label>
                        <input type="number" id="quantity-<?php echo htmlspecialchars($item['id']); ?>" name="quantity" value="<?php echo htmlspecialchars($item['quantity']); ?>" min="1" max="99" aria-label="Quantity">
                        <button type="submit" name="update_quantity">Update</button>
                    </form>
                  </div>
                  <div class="checkout-item-price">$<?php echo number_format($item['price'] * $item['quantity'], 2); ?></div>
                  <a href="checkout.php?remove_from_cart=<?php echo htmlspecialchars($item['id']); ?>" class="remove-item-btn" aria-label="Remove <?php echo htmlspecialchars($item['name']); ?> from cart">
        ...
        <section class="checkout-section" style="flex: 1;">
          ...
          <form class="shipping-form" method="post" action="checkout.php">
  ...
  <!-- Footer (identical to ourproducts.php) -->
  <footer>
  ...
  <script>
    // Mobile menu toggle (from ourproducts.php)
    ...
    if (cartBtn) {
        cartBtn.addEventListener('click', () => {
            ...
            // or you could redirect to ourproducts.php if desired.
