...
.add-to-cart-form button:focus {
  ...
  box-shadow: 0 4px 10px rgba(0, 0, 0, 0.15);
    ...
    /* Footer Styles (identical to index.php) */
    footer {
      background: #000;
      color: #fff;
      padding: 3rem 2;
    ...
    <div class="container">
      ...
      <section class="filter-section" aria-label="Product Filters">
        ...
        <select id="category-filter" onchange="window.location.href = this.value;">
          <option value="ourproducts.php?category=all" <?php echo (!isset($_GET['category']) || $_GET['category'] === 'all') ? 'selected' : ''; ?>>All Categories</option>
          <?php foreach ($categories as $category): ?>
            <option value="ourproducts.php?category=<?php echo urlencode($category); ?>" <?php echo (isset($_GET['category']) && $_GET['category'] === $category) ? 'selected' : ''; ?>>
      ...
      <section class="product-grid" aria-label="Product Listings">
        ...
        <?php else: ?>
            ...
            <article class="product-card" tabindex="0" aria-label="<?php echo htmlspecialchars($product['name']); ?>">
                <img src="<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" />
                <div class="product-info">
                <h4><?php echo htmlspecialchars($product['name']); ?></h4>
                <p><?php echo htmlspecialchars($product['description']); ?></p>
                <div class="product-price">$<?php echo number_format($product['price'], 2); ?></div>
                <form class="add-to-cart-form" method="post" action="ourproducts.php">
        ...
        <?php else: ?>
          ...
          ?>
            <li class="cart-item">
              ...
              <a href="ourproducts.php?remove_from_cart=<?php echo htmlspecialchars($item['id']); ?>" class="remove-item-btn" aria-label="Remove <?php echo htmlspecialchars($item['name']); ?> from cart">
