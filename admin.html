...
<head>
    ...
    <style>
        /* Inherit styles consistent with contact.php */
        :root {
            --color-bg: #ffffff;
        ...
        * {
        ...
        /* Dropdown styles (copied from contact.php) */
        .dropdown {
            position: relative;
        ...
        /* Cart button styling (copied from contact.php) */
        .cart-btn {
            background: none;
            border: none;
            cursor: pointer;
        ...
        /* Cart Modal Styles (copied from contact.php) */
        .cart-modal {
        ...
        /* Footer Styles (identical to contact.php) */
        footer {
            background: #000;
            color: #fff;
        ...
        .social-links {
            display: inline; /* Changed to inline to match contact.php */
            gap: 1rem; /* Changed to 2rem to match contact.php */
        }
      ...
      /* Added for consistency with ourproducts.php */
      .cart-modal-content {
        width: 95%;
        padding: 1.5rem;
      }
...
<body>
    <header>
        ...
        <nav>
            <ul id="primary-navigation" role="menu">
                <li><a href="index.php" role="menuitem" tabindex="0">Home</a></li>
                <li><a href="add_product.php"><i class="fas fa-box"></i> Manage Products</a></li>
                <li><a href="admin_orders_summary.php"><i class="fas fa-clipboard-list"></i> View Orders</a></li>
                <li><a href="admin_contacts.php"><i class="fas fa-envelope"></i> Contact Messages</a></li>
            ...
            <!-- Cart Button (copied from contact.php) -->
    ...
    <!-- Cart Modal (copied from contact.php) -->
    ...
    <script>
        ...
        // Cart Modal functionality (copied from contact.php)
